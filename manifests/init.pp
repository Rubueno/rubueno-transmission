...
#
class transmission (
  $manage_epel                    = $transmission::params::manage_epel,
  ...
  $rpc_host_whitelist             = $transmission::params::rpc_host_whitelist,
  $rpc_host_whitelist_enabled     = $transmission::params::rpc_host_whitelist_enabled,
